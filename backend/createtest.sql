create table tb_order (id bigserial not null, address varchar(255), latitude float(53), longitude float(53), moment timestamp(6) with time zone, status smallint, primary key (id));
create table tb_order_product (order_id bigint not null, product_id bigint not null, primary key (order_id, product_id));
create table tb_product (id bigserial not null, description varchar(255), image_uri varchar(255), name varchar(255), price float(53), primary key (id));
